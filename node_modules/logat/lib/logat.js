...
function logEvent(evname) {
    ...
    if (this.options.logMethod == LogMethodE.CONSOLE) {
        var logMsg = colors[evname] + ("[" + evname.toUpperCase() + "] ");
        ...
        for (var i = 0; i < params.length; i++) {
            ...
            console.log(logMsg+params[i]+colors.reset + " at" + colors.fgmagenta + " " + logLineDetail + " " + colors.reset);
        }
    }
    else {
        var logMsg = "[" + evname.toUpperCase() + " at  " + logLineDetail;
